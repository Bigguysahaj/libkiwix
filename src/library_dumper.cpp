...
{
/* Constructor */
LibraryDumper::LibraryDumper(const Library* const library, const NameMapper* const nameMapper)
  : library(library),
...
std::string LibraryDumper::humanFriendlyTitle(std::string title) const
{
...
kainjow::mustache::list LibraryDumper::getCategoryList() const
{
...
kainjow::mustache::list LibraryDumper::getLanguageList() const
{
  const auto now = gen_date_str();
